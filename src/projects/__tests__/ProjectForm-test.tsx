...
describe('<ProjectForm />', () => {
  ...
  test( 'should accept input',()=>{
    ...
    userEvent.type(screen.getByRole('textbox',{ name: /project description/i}), updatedProject.description);
  ...
  test('name should display minlength validatio',async ()=>{
      userEvent.clear(nameTextBox);
      userEvent.type(nameTextBox, 'ab');
      console.log(expect(screen.findByRole('alert')));
